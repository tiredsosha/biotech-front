...
export const setZonesPowerThunk = (zoneName, powerValue) => (dispatch) => {
  axios.post('http://127.0.0.1:8080/zonespower', { [zoneName]: powerValue });
  if (!powerValue) {
...
export const setZonesSoundThunk = (zoneName, soundValue) => (dispatch) => {
  axios.post('http://127.0.0.1:8080/zonessound', { [zoneName]: soundValue });
};

export const setZonesLedThunk = (zoneName, ledValue) => (dispatch) => {
  axios.post('http://127.0.0.1:8080/zonesled', { [zoneName]: ledValue });
};
